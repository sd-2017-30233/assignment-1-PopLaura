...
public class MangTransaction {
    ...
    {
       //Validare
        tranzactie.TransferIntreConturi(nr_cont_sursa, payG, amount, "Factura gaz", user_id);
        return null;
    }
    //-------------------------APA-----------------------------------------
    ...
    {
       //Validare
        tranzactie.TransferIntreConturi(nr_cont_sursa, payW, amount, "Factura apa", user_id);
        return null;
    }
    //-------------------------CUERENT ELECTRIC----------------------------
    ...
    {
       //Validare
        tranzactie.TransferIntreConturi(nr_cont_sursa, payE, amount, "Factura CURENT ELECTRIC", user_id);
        return null;
    }
